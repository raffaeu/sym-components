...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_get_iterator__ = __webpack_require__(50);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    ...
    groups: function groups() {
      ...
      try {
        for (var _iterator = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_get_iterator___default()(this.items), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var item = _step.value;

          var currentCategory = item[this.groupBy];
  ...
  props: {
    ...
    groupHeaderFormatter: {
      type: Function,
      required: false,
      default: function _default(group) {
        if (!group) {
          return '';
        }
    ...
    toggleSort: function toggleSort(col) {
      ...
      this.columns.forEach(function (element) {
        if (element !== col && element.sortable) {
          __WEBPACK_IMPORTED_MODULE_2_vue___default.a.set(element, 'sorted', false);
        }
      });

      if (!col.sorted) {
        __WEBPACK_IMPORTED_MODULE_2_vue___default.a.set(col, 'sorted', true);
        __WEBPACK_IMPORTED_MODULE_2_vue___default.a.set(col, 'sort_order', 'ASC');
      } else {
        __WEBPACK_IMPORTED_MODULE_2_vue___default.a.set(col, 'sort_order', col.sort_order === 'DESC' ? 'ASC' : 'DESC');
      }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_sym_data_table_SymDataTable__ = __webpack_require__(29);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_SymDataTable_vue__ = __webpack_require__(15);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1bf0bae8_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_SymDataTable_html__ = __webpack_require__(69);
var disposed = false
...
var update = __webpack_require__(33)("74eb1204", content, false);
                  ...
                  [
                    ...
                    _vm._l(_vm.groups, function(group) {
                      return _c(
                        ...
                        [
                          group.header
                            ? _c("tr", { staticClass: "group-header" }, [
                                _c("td", { staticClass: "sym-row-begin" }),
                                _vm._v(" "),
                                _c(
                                  "td",
