...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1bf0bae8_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_SymDataTable_html__ = __webpack_require__(10);
var disposed = false
...
var update = __webpack_require__(5)("74eb1204", content, false);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mounted: function mounted() {
    ...
    this.columns.forEach(function (element) {
      __WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(element, 'sorted', false);
    });
  },
  ...
  methods: {
    ...
    toggleSort: function toggleSort(col) {
      ...
      if (!col.sorted) {
        __WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(col, 'sorted', true);
        __WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(col, 'sort_order', 'ASC');
      } else {
        __WEBPACK_IMPORTED_MODULE_0_vue___default.a.set(col, 'sort_order', col.sort_order === 'DESC' ? 'ASC' : 'DESC');
      }
                      ...
                      [
                        ...
                        _vm._l(_vm.columns, function(col, colIndex) {
                          return _c(
                            ...
                            [
                              _vm.sortable && col.sortable && col.sorted
                                ? _c(
                                    "i",
                                    {
